...
class Canteen(models.Model):
    ...
    canteen_campus = models.CharField(max_length=20, verbose_name='食堂所属校区')
    ...
    def get_shop_url(self):
        return reverse("canteen:shop", kwargs={'canteen_id': self.canteen_id})
...
class Shop(models.Model):
    ...
    def get_dish_url(self):
        return reverse("dish:show_dish", kwargs={'shop_id': self.shop_id})
