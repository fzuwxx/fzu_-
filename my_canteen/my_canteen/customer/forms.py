...
class UpdateForm(forms.Form):
    studentID = forms.CharField(label="学号", max_length=20, widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': "studentID", 'autofocus': ''}))
    campus = forms.CharField(label="所属校区", max_length=20, widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': "campus", 'autofocus': ''}))
